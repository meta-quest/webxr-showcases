# Contributing to WebXR Showcases
...
WebXR Showcases uses `eslint` and `prettier` to lint and format code.
...
By contributing to WebXR Showcases, you agree that your contributions will be licensed
